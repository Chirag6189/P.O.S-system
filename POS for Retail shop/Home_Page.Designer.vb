...
Partial Class Home_Page
    ...
    Private Sub InitializeComponent()
        ...
        pnlStaff = New Guna.UI2.WinForms.Guna2Button()
        pnlBranch = New Guna.UI2.WinForms.Guna2Button()
        pnlProfile = New Guna.UI2.WinForms.Guna2Button()
        pnlSupport = New Guna.UI2.WinForms.Guna2Button()
        pnlLogout = New Guna.UI2.WinForms.Guna2Button()
        ...
        Guna2Panel1.Controls.Add(btnclosepage)
        Guna2Panel1.Controls.Add(lblpagename)
        Guna2Panel1.Controls.Add(btnSidebox)
        Guna2Panel1.CustomizableEdges = CustomizableEdges3
        Guna2Panel1.Dock = DockStyle.Top
        Guna2Panel1.Location = New Point(0, 0)
        Guna2Panel1.Name = "Guna2Panel1"
        Guna2Panel1.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        Guna2Panel1.Size = New Size(1940, 42)
        Guna2Panel1.TabIndex = 0
        ' 
        ' btnclosepage
        ' 
        btnclosepage.CustomizableEdges = CustomizableEdges1
        btnclosepage.DisabledState.BorderColor = Color.DarkGray
        btnclosepage.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        btnclosepage.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        btnclosepage.Size = New Size(58, 39)
        ...
        ' btnSidebox
        ' 
        btnSidebox.Image = CType(resources.GetObject("btnSidebox.Image"), Image)
        btnSidebox.Location = New Point(2, 1)
        btnSidebox.Name = "btnSidebox"
        btnSidebox.Size = New Size(44, 39)
        ...
        SideBar.Controls.Add(pnldashboard1)
        SideBar.Controls.Add(pnlActivitys)
        SideBar.Controls.Add(pnlAnalysis)
        SideBar.Controls.Add(pnlProduct)
        SideBar.Controls.Add(pnlStaff)
        SideBar.Controls.Add(pnlBranch)
        SideBar.Controls.Add(pnlProfile)
        ...
        SideBar.Padding = New Padding(0, 0, 10, 0)
        SideBar.Size = New Size(234, 1058)
        SideBar.TabIndex = 1
        ' 
        ' Guna2Panel2
        ' 
        ...
        pnlActivitys.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        pnlAnalysis.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        pnlProduct.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        pnlStaff.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        pnlBranch.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        pnlProfile.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        pnlSupport.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        ' pnlLogout
        ' 
        pnlLogout.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        pnlLogout.BorderRadius = 10
        pnlLogout.CustomizableEdges = CustomizableEdges23
        pnlLogout.DisabledState.BorderColor = Color.DarkGray
        pnlLogout.DisabledState.CustomBorderColor = Color.DarkGray
        ...
        Paneldisplay.Location = New Point(234, 42)
        Paneldisplay.Name = "Paneldisplay"
        Paneldisplay.Size = New Size(1706, 1058)
        ...
        CType(btnSidebox, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents pnlProduct As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents pnlStaff As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents pnlBranch As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents pnlProfile As Guna.UI2.WinForms.Guna2Button
